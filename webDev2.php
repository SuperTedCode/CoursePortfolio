...
<div class="jumbotron">
  <div class="container text-center">
    ...
    <h2>Semester two</h2>
    <p>I have included some labs, Assessments and the final project for this module. Again the project is accessed through Github.</p>
  </div>
</div>
...
<div class="row">
    ...
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        The link above will take you to my GitHub account where the project is available to download. Please follow the installation guide carefully.<br>
